    ...
    <div class="h-20 mt-6 flex container mx-auto text-3xl">
        ...
        <ul class="flex mr-10">
            <c:if test='${rq.getLoginedMemberId() == 0 }'>
                ...
                <li class="hover:underline"><a class="h-full px-3 flex items-center" href="/page/member/join"><span>회원가입</span></a></li>
            </c:if>
            <c:if test='${rq.getLoginedMemberId() != 0 }'>
                <li class="hover:underline"><a class="h-full px-3 flex items-center" href="/page/member/myPage"><span>MYPAGE</span></a></li>
                <li class="hover:underline"><a
                    class="h-full px-3 flex items-center" href="/page/member/doLogout"><span>로그아웃</span></a></li>
            </c:if>
        </ul>
